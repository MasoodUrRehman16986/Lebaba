  ...
  return (
    <>
      <section className="section__container bg-primary-light">
        <h2 className="section__header capitalize">Information</h2>
      ...
      <section className="section__container mt-8">
        <div className="flex flex-col items-center md:flex-row gap-8">
          ...
          <div className="md:w-1/2 w-full">
            ...
            <p className="text-gray-400 mb-4">This is a product disdvsdvd</p>
            ...
            <button className="mt-6 px-6 py-3 text-white bg-primary rounded-md">
              Add to Cart
            </button>
          </div>
        </div>
